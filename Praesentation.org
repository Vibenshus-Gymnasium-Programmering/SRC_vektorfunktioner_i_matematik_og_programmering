...
#+begin_src python -n :exports both :results none :eval never-export :comments link :tangle ret_linje_imperativ.py 
...
#+begin_src python -n :exports both :results none :eval never-export :comments link :tangle cirkel_imperativ.py
...
#+begin_src python -n :exports both :results none :eval never-export :comments link :tangle sammensat_linje_cirkel.py
...
#+begin_src python -n :exports both :results none :eval never-export :comments link :tangle ret_linje_klasse_ny.py
import arcade
BREDDE = 800
HOEJDE = 600
SPORLAENGDE = 200
...
#+begin_src python -n :exports both :results none :eval never-export :comments link :tangle cirklen_klasse_ny.py
import arcade
import math
BREDDE = 800
HOEJDE = 600
...
#+begin_src python -n :exports both :results none :eval never-export :comments link :tangle ret_linje_og_cirken_sammensat_klasse_ny.py
import arcade
import math
BREDDE = 800
HOEJDE = 600
...
#+begin_src python -n :exports both :results none :eval never-export :comments link :tangle ret_linje_og_cirkel_sammensat_som_sum.py
import arcade
import math
BREDDE = 800
HOEJDE = 600
